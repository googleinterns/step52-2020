...
public abstract class CheckForApiAuthorizationServlet extends HttpServlet {
  ...
  */
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    try {
      ...
      response.sendRedirect("/JSP/test.jsp?idToken=" + idTokenString);
  ...
  */
  private GoogleAuthorizationCodeFlow getFlow() throws IOException, FileNotFoundException, GeneralSecurityException {
    NetHttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
